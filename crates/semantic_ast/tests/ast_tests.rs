...
//
// Structs representing expressions in AST
//
...
#[test]
fn test_annotation() {
    let a = ast::Annotation::new("ann".to_string(), Some("details".to_string()));
    let b = ast::Annotation::new("ann".to_string(), None);
